import { FaInstagram, FaTelegramPlane, FaArrowCircleUp,FaGithub  } from "react-icons/fa";
    ...
    return (
        <div className="bg-gray-50 dark:bg-[#101e38]">
            <div className="lg:w-[1200px] md:mx-auto h-full border-x border-gray-100 dark:border-gray-800 bg-white dark:bg-[#0e182c]">
                ...
                <div id="skills" className="flex flex-wrap lg:flex-nowrap justify-between gap-12 mt-20 md:px-16">
                    {/* Skills */}
                    <div>
                                ...
                                user_info.experience.map((experience, index) => {
                                    return (
                                        <div key={index} className="flex gap-4 mt-8">
                                            ...
                                            <div className="w-full">
                                                <h5 className="font-medium text-gray-600 dark:text-gray-300">{experience.company}</h5>
                                                <div className="flex justify-between">
                                                    <p className="text-gray-500 dark:text-gray-300 text-sm w-full">{experience.domain}</p>
                                                    <p className="text-gray-500 dark:text-gray-300 text-right w-[80%] text-sm">{experience.duration}</p>
                                                </div>
                                                <br/>
                                                <p className="text-gray-500 dark:text-gray-300 text-left w-[100%] text-sm">{experience.description}</p>
                                            </div>
                                        </div>
                                    )
                                })
