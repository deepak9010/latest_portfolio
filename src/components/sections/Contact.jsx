  ...
  return (
    <section id="contact" className="mt-16 pt-12 px-6 lg:px-24">
      ...
      <div className="mt-12">
        ...
        {/* =========== X =========== */}
        <a
          href={user_info.socials.twitter} target="_blank"
        ...
        >
          <FaXTwitter className="self-center text-lg text-red-800 dark:text-red-500" />
          <span className="self-center">Follow on X</span>
        </a>

            {/* =========== LINKEDIN =========== */}
            <a
          href={user_info.socials.linkedin} target="_blank"
          className="flex gap-4 text-zinc-600 dark:text-zinc-300 hover:dark:text-zinc-300 hover:text-zinc-700 transition-all duration-300 mt-4"
        >
        ...
        {/* =========== INSTAGRAM =========== */}
        <a
          href={user_info.socials.instagram} target="_blank"
          className="flex gap-4 text-zinc-600 dark:text-zinc-300 hover:dark:text-zinc-300 hover:text-zinc-700 transition-all duration-300 mt-4"
        >
      ...
      {/* =========== EMAIL =========== */}
      <a
        href={`mailto:${user_info.main.email}`} target="_blank"
